 ...
 */
public class FourPlayerLayout extends GridLayout implements PlayerLayout {
	private static final long serialVersionUID = 1L;

	/**
	 */
	public FourPlayerLayout() {
		super();
	}
	...
	public Component getComponent() {
		...
		col3.add(spacer2);
		col3.add(componentMap.get(WizardComponentEnum.EAST_HAND));
		col3.add(spacer3);
		mainPanel.add(col3);
		...
		col4.add(componentMap.get(WizardComponentEnum.SCORE_BOARD));
		mainPanel.add(col4);
		*/
