 ...
 */
public class SixPlayerLayout extends GridLayout implements PlayerLayout {
	private static final long serialVersionUID = 1L;

	/**
	 */
	public SixPlayerLayout() {
		super();
	}
	...
	private Component spacer4 = createSpacer();
	private Component spacer5 = createSpacer();
	...
	private void setAllSizes() {
		...
		Component southSouthEast = componentMap.get(WizardComponentEnum.SOUTH_SOUTH_EAST_HAND);
		...
		Component southSouthEastCardPlayedPanel = componentMap.get(WizardComponentEnum.SOUTH_SOUTH_EAST_CARD_PLAYED);
		...
		Component southSouthEastTrick  =  componentMap.get(WizardComponentEnum.SOUTH_SOUTH_EAST_TRICK);
		...
		setSize(spacer4, new Dimension(30,30));
		setSize(spacer5, new Dimension(30,30));
		...
		setSize(southSouthEastTrick, new Dimension(actualWidth, textHeight));

		setSize(southEastCardPlayedPanel, new Dimension(cardWidth, cardHeight));
		setSize(southSouthEastCardPlayedPanel, new Dimension(cardWidth, cardHeight));
		
		setSize(southEast, new Dimension(cardHeight + cardMove, handWidth));
		setSize(southSouthEast, new Dimension(cardHeight + cardMove, handWidth));
	}
